...
find_library(OPENIMAGEIO_UTIL_LIBRARY NAMES OpenImageIO_Util
  HINTS
        ...
        # ${OPENIMAGEIO_CHECK_LIBRARY_DIRS}
  PATH_SUFFIXES ${OPENIMAGEIO_CHECK_LIBRARY_SUFFIXES})
if (NOT OPENIMAGEIO_UTIL_LIBRARY OR
    NOT EXISTS ${OPENIMAGEIO_UTIL_LIBRARY})
  openimageio_report_not_found(
    "Could not find OpenImageIO library, set OPENIMAGEIO_UTIL_LIBRARY "
    "to full path to libopenimageio.")
endif (NOT OPENIMAGEIO_UTIL_LIBRARY OR
       NOT EXISTS ${OPENIMAGEIO_UTIL_LIBRARY})
